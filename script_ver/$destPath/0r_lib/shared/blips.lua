-- ============================================================
-- GTA V Blip Sprite and Color Definitions
-- Complete mapping of blip IDs to their radar icon names
-- and color definitions for the minimap/radar system.
-- ============================================================

-- ── Blip Sprite Definitions ────────────────────────────────
-- Maps blip IDs to their corresponding radar icon names.
-- These are used by SetBlipSprite() in FiveM/GTA V natives.

Blips = {
    -- Basic navigation and player markers (0-16)
    ...
    -- Multiplayer and vehicles (27-44)
    ...
    -- Story characters and heists (76-136)
    ...
    -- Additional locations and objectives (138-198)
    ...
    -- Missions and game modes (281-350)
    ...
    -- DLC and additional content (351-432)
...
-- ── Blip Color Definitions ─────────────────────────────────
-- Maps color IDs to their hex values and display names.
-- These are used by SetBlipColour() in FiveM/GTA V natives.
