# Reporte de Auditoría de Seguridad — AUD-006
...
- Inventario completo con SHA-256: `reports/audit_AUD-006_0r-imagegenerator_2026-04-15_hashes.tsv`
...
Sin acceso auditable al código crítico no es posible garantizar:

- ausencia de backdoors o exfiltración,
- validación server-side correcta,
- controles de permisos/eventos,
- seguridad de flujo NUI↔server.
...
1. Entregar versión no compilada/no ofuscada de scripts críticos (`server/*`, `client/*`, `shared/config_sv.lua`).
2. Mantener dependencias NUI locales o de origen confiable con justificación.
3. Reingresar a `quarantine/incoming` para nueva auditoría completa.
