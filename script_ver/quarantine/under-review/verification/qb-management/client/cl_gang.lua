...
RegisterNetEvent('qb-gangmenu:client:SocietyWithdraw', function(saldoattuale)
    ...
    if withdraw then
        ...
        TriggerServerEvent('qb-logs:server:createLog', 'bossmenu', 'Withdraw Money', xPlayer.PlayerData.charinfo.firstname .. ' ' .. xPlayer.PlayerData.charinfo.lastname .. ' successfully withdrew $' .. amount .. ' (' .. gang .. ')', false, src)
    end
end)
