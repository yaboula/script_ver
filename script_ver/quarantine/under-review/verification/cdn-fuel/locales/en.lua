local Translations = {
    ...
    station_price_too_high = "This price is too high! [MAX: $16]",
    station_price_too_low = "This price is too low! [MIN: $2]",
    ...
    menu_ped_purchase_location_header = "Purchase This Location - ($2,200,000)",
