...
Config.FurnitureTypes = {
    ...
    ["clothing"] = function(entity, property_id)
        Framework[Config.Target].AddTargetEntity(entity, "Clothing", "fas fa-shirt", function()
            ...
            TriggerEvent("0r-outfitsaver:openMenu:server")
        end)
...
Config.Furnitures = {
    {
        ...
        items = {
            { ["object"] = "v_res_tre_storagebox", ["price"] = 500, ["label"] = "Storage Unit", ["type"] = "storage", ["max"] = 3 },
            { ["object"] = "v_res_tre_wardrobe", ["price"] = 650, ["label"] = "Wardrobe", ["type"] = "clothing", ["max"] = 1 },
        }
    },
...

    {
        ...
        items = {
            ...
            { ["object"] = "v_corp_servercln", ["price"] = 50000, ["label"] = "Crypto Server Miner",["max"] = 1  },
        }
    },
