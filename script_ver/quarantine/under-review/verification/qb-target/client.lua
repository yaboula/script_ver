...
exports['qb-target']:AddTargetModel(`mp_m_shopkeep_01`, {
    options = {
        { 
            ...
            -- Add shop index parameter here
            action = function(entity)
                -- Determine which shop index this NPC should open
                -- This could be hardcoded or fetched from some configuration
                local shopIndex = "247" -- Example index, adjust as needed
                TriggerEvent('av_shops:open', "247")
            end
        },
    },
    distance = 2.0 
    ...
    options = {
        { 
            ...
            action = function(entity)
                -- Determine which shop index this NPC should open
                -- This could be hardcoded or fetched from some configuration
                local shopIndex = "weed" -- Example index, adjust as needed
                TriggerEvent('av_shops:open', "weed")
            end
        },
    },
    distance = 2.0 
...
---- Phone store
exports['qb-target']:AddTargetModel(`ig_bestmen`, {
    options = {
        { 
            event = 'nh-context2:shopmenu2', 
            ...
            action = function(entity)
                -- Determine which shop index this NPC should open
                -- This could be hardcoded or fetched from some configuration
                local shopIndex = "electronic_store" -- Example index, adjust as needed
                TriggerEvent('av_shops:open', "electronic_store")
            end
        },
    },
    distance = 2.0 
	...
	options = {
        { 
            ...
            label = "Speak with Weapon Dealer",
                ...
                -- Determine which shop index this NPC should open
                -- This could be hardcoded or fetched from some configuration
                local shopIndex = "weapons" -- Example index, adjust as needed
                TriggerEvent('av_shops:open', "weapons")
            end
        },
	},
	distance = 2.0 
	...
	options = {
        { 
			...
			action = function(entity)
                -- Determine which shop index this NPC should open
                -- This could be hardcoded or fetched from some configuration
                local shopIndex = "hardware" -- Example index, adjust as needed
                TriggerEvent('av_shops:open', "hardware")
            end
        },
	},
	distance = 2.0 
