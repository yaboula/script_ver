...
-- ✅ FIXED: Clean single MotelZone function with proper zones/blips init and safe onExit
...
MotelZone = function(data)
    ...
    function onExit(self)
        inMotelZone = false
        lib.hideTextUI() -- ✅ force hide the UI on exit
        if point then
            point:remove() -- ✅ safely remove point
            point = nil
        end
