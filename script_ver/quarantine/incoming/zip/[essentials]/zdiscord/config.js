...
// PUBLIC VALUES
const FiveMServerName = "Cooming Soon";
const DiscordInviteLink = "https://discord.gg/nJn2YPsj";
const FiveMServerIP = "Cooming Soon";
...
// DISCORD BOT
const DiscordBotToken = "MTQ3Mjc1MjMxNDQ0NzE2NzQ5OA.G-44aA.zoUPr-o0yPyJ3FvHYH0z6QzlEy4IU1ETqYieMw";
const DiscordGuildId = "750324200400617482";

// STAFF CHAT
const EnableStaffChatForwarding = true;
const DiscordStaffChannelId = "772225867769184306";
...
const DiscordWhitelistRoleIds = "772225839764340757, 772225837797212211";

// SLASH COMMANDS / DISCORD PERMISSIONS
const EnableDiscordSlashCommands = true;
const DiscordModRoleId = "772225738912825345";
const DiscordAdminRoleId = "772225734718521376";
const DiscordGodRoleId = "772225733527076894";
