...
Config = {
    ...
    Compatibility = {
        ...
        Others = {
            ...
            distance = 35.0, -- Distance to speak (when you use pma-voice, modify directly the distance in the @pma-voice/client/megaphone.lua file of the pma-voice script, for more information please refer to our documentation)
...
Config.Languages = {
    ...
    ['CN'] = {
        ['speak'] = '使用扩音器说话请按 '..Config.Keys.SpeakKeyString,
        ['speakcar'] = '使用扩音器说话请按 '..Config.Keys.SpeakCarKeyString,
        ['managevolume'] = '音量: ~r~{s}%',
    }
}
------- launcherleaks TomRonnie
