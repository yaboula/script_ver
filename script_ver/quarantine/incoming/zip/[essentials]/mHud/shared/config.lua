...
Config.MouseCursorKey = 57 -- Whatever you set Config.EnableRegisterKeyMapping if you want to change key for cursor only reference here https://docs.fivem.net/docs/game-references/controls/
Config.MouseCursorKeyLabel = "F10"
...
Config.WaterMarkInformations = { -- informations displayed in the upper right watermark
    logo = "https://r.resimlink.com/6s7S-X8K0.png",
    servername = "BABERP",
    discordlink = "discord.gg/toxicfivem"
}
...
Config.Fuel = function(vehicle)
    if DoesEntityExist(vehicle) then
        if GetResourceState('origen_fuel') == 'started' then
            return exports["origen_fuel"]:GetFuel(vehicle)
        end
