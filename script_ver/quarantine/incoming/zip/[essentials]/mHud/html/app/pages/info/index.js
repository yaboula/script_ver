...
const Hud = {
    ...
    computed: {
        ...
        getMaxWidth() {
            ...
            const widths = [...jobs, displayTextWidth("MROLEPLAY.COM", "6px Gilroy"), displayTextWidth(this.accounts.bank.toString(), "15px Gilroy"), displayTextWidth(this.accounts.cash.toString(), "15px Gilroy"), displayTextWidth(this.accounts.black_money.toString(), "15px Gilroy"), displayTextWidth(this.accounts.vip_money.toString(), "15px Gilroy"), displayTextWidth(this.accounts.boss_money.toString(), "15px Gilroy")]
