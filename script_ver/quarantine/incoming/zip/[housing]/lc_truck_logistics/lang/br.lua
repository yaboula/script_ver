...
Lang['br'] = {
    ...
    ['fast_cargo_timer'] = '~w~Você tem ~b~%s~w~ segundos para entregar a ~y~carga~w~.',
    ['failed_urgent_time'] = "Você não conseguiu entregar a carga urgente a tempo. Você receberá uma penalidade de %s%% na recompensa",
    ['failed_fragile_health'] = "Você não conseguiu entregar a carga frágil com mais de %s%% de integridade. Você receberá uma penalidade de %s%% na recompensa",
    ...
    ['cargo_inspect_interaction'] = "Pressione ~INPUT_CONTEXT~ para inspecionar a carga",
    ['cargo_inspect_interaction_target'] = "Inspecionar a carga do reboque",
    ['cargo_inspect_message'] = "Relatório de inspeção: Carga identificada como '%s'",
    ['cargo_inspect_empty'] = "Vazio",
    ['cargo_inspect_illegal_message'] = "Carga suspeita detectada: %s",
    ['cargo_inspect_must_be_police'] = "Você deve ser policial para fazer isso.",
    ['cargo_inspect_loading'] = "Inspecionando...",
