...
Lang["en"] = {
    ...
    contract_page_cargo_illegal: "Illegal cargo",
    ...
    skills_page_distance_description: `
		...
		<ul>
			Level 1:
			<li> Deliveries up to 6km </li>
			<li> 2% reward for distances greater than 6km </li>
			<li> 5% experience bonus for distances greater than 6km </li>
			<BR> Level 2:
			<li> Deliveries up to 7km </li>
			<li> 4% reward for distances greater than 6.5km </li>
			<BR> Level 3:
			<li> Deliveries up to 7.5km </li>
			<li> 6% reward for distances greater than 7km </li>
			<BR> Level 4:
			<li> Deliveries up to 8km </li>
			<li> 8% reward for distances greater than 7.5km </li>
			<BR> Level 5:
			<li> Deliveries up to 8.5km </li>
			<li> 10% reward for distances greater than 8km </li>
			<BR> Level 6:
			<li> Deliveries anywhere </li>
			<li> 12% reward for distances greater than 8.5km </li>
		</ul>`,
    ...
    skills_page_valuable_desc: `
		...
		<ul>
			...
			<li> 2% reward for valuable deliveries </li>
			<li> 10% experience bonus for valuable deliveries </li>
			<BR> Level 2:
			<li> 4% reward for valuable deliveries </li>
			<BR> Level 3:
			<li> 6% reward for valuable deliveries </li>
			<BR> Level 4:
			<li> 8% reward for valuable deliveries </li>
			<BR> Level 5:
			<li> 10% reward for valuable deliveries </li>
			<BR> Level 6:
			<li> 12% reward for valuable deliveries </li>
		</ul>`,
    ...
    skills_page_fragile_desc: `
		...
		<ul>
			...
			<li> 2% reward for fragile cargo deliveries </li>
			<li> 10% experience bonus for fragile cargo deliveries </li>
			<BR> Level 2:
    ...
    skills_page_fast_desc: `
		...
		<ul>
			...
			<li> 2% reward for urgent cargo deliveries </li>
			<li> 10% experience bonus for urgent cargo deliveries </li>
			<BR> Level 2:
			<li> 4% reward for urgent cargo deliveries </li>
			<BR> Level 3:
			<li> 6% reward for urgent cargo deliveries </li>
			<BR> Level 4:
			<li> 8% reward for urgent cargo deliveries </li>
			<BR> Level 5:
			<li> 10% reward for urgent cargo deliveries </li>
			<BR> Level 6:
			<li> 12% reward for urgent cargo deliveries </li>
		</ul>`,
    skills_page_illegal_title: "Illegal cargo",
    skills_page_illegal_desc: `
        <p>Smuggling contraband is a high-risk, high-reward business. Only the boldest and most cunning drivers dare to take on these shadowy jobs.</p>
        <ul>
            Level 1:
            <li> Unlocks illegal cargo jobs</li>
            <li> 2% reward bonus for illegal deliveries</li>
            <li> 10% experience bonus for illegal deliveries</li>
            <BR> Level 2:
            <li> 4% reward bonus for illegal deliveries</li>
            <BR> Level 3:
            <li> 6% reward bonus for illegal deliveries</li>
            <BR> Level 4:
            <li> 8% reward bonus for illegal deliveries</li>
            <BR> Level 5:
            <li> 10% reward bonus for illegal deliveries</li>
            <BR> Level 6:
            <li> 12% reward bonus for illegal deliveries</li>
        </ul>
`,
