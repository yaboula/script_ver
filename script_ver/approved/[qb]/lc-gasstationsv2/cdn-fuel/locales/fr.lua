...
local Translations = {
    ...
    station_success_withdrew_2 = " du solde de cette station!",
    ...
    station_success_deposit_2 = " dans l'équilibre de cette station!",
    ...
    station_name_change_success = "Successfully changed name to: ",
    ...
    input_insert_nozzle = "Insérer la buse",
