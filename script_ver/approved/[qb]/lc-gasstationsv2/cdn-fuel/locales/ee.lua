...
local Translations = {
    ...
    station_success_withdrew_2 = " tankla arvelt!",
    ...
    station_success_deposit_2 = " tankla arvele!",
    ...
    station_name_change_success = "Edukalt muudetud nime, uus nimi: ",
