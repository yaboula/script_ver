...
local Translations = {
    ...
    station_success_withdrew_2 = " desde el balance de esta Estación!",
    ...
    station_success_deposit_2 = " dentro del balance de esta Estación!",
    ...
    station_name_change_success = "Cambiaste el nombre a: ",
    ...
    input_insert_nozzle = "Insertar Boquilla en el auto",
