...
local Translations = {
    ...
    station_success_withdrew_2 = " vom Tankstellenkonto!",
    ...
    station_success_deposit_2 = " auf das Tankstellenkonto!",
    ...
    station_name_change_success = "Erfolgreich den Namen geändert in: ",
    ...
    input_insert_nozzle = "Zapfhahn einsetzen",
