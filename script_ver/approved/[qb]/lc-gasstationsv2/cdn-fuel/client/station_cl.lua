...
if false then
    ...
    RegisterNetEvent('cdn-fuel:stations:client:purchasereserves:final', function(location, price, amount)
    ...
    RegisterNetEvent('cdn-fuel:stations:client:sellstation:menu', function(data)
        local location = data.location
    ...
    RegisterNetEvent('cdn-fuel:stations:client:changestationname', function()
        CanOpen = false
    ...
    RegisterNetEvent('cdn-fuel:stations:client:managemenu', function(location)
    ...
    RegisterNetEvent('cdn-fuel:stations:client:managefunds', function(location)
        QBCore.Functions.TriggerCallback('cdn-fuel:server:isowner', function(result)
    ...
    RegisterNetEvent('cdn-fuel:stations:openmenu', function()
