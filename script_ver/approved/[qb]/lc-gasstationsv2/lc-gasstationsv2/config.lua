...
Config.max_stations_per_player = 1
Config.max_stations_employed = 2
Config.max_jobs = 20
Config.disable_rename_business = false
Config.group_map_blips = true
Config.enable_different_fuels = true
Config.gas_station_locations = {

	["gas_station_1"] = {
		['buy_price'] = 800000,
		['sell_price'] = 400000,
		['coord'] = {289.27,-1267.01,29.45},
		['map_blip_coord'] = {289.27,-1267.01,29.45},
		['truck_coord'] = {278.33,-1243.18,29.2,185.71},
		['trailer_coord'] = {284.9,-1245.9,29.22,178.75},
		['deliveryman_coord'] = {288.56,-1269.86,29.45},
		['truck_parking_location'] = {279.50,-1246.65,29.45,89.32},
...
Config.gas_station_types = {
	...
	['small_gas_station'] = {
		...
		['electric_normal_price'] = 3000,
		['electric_fast_price'] = 9000,
		['upgrades'] = {
			['stock'] = {
				['price'] = 20000,
				['level_reward'] = {
