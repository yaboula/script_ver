...
function Utils.Vehicles.setVehicleProperties(vehicle, props)
	...
	if props.color1 then
		...
		if type(props.color1) == 'table' then
			...
			SetVehicleColours(vehicle, tonumber(props.color1)
		end
	...
	if props.color2 then
		...
		if type(props.color2) == 'table' then
			...
			SetVehicleColours(vehicle, tonumber(props.color1) or colorPrimary
		end
	...
	if props.extras then
		...
		for id, disable in pairs(props.extras) do
			...
			SetVehicleExtra(vehicle, tonumber(id)
		end
	...
	if props.tyres then
		...
		for tyre, state in pairs(props.tyres) do
			...
			SetVehicleTyreBurst(vehicle, tonumber(tyre)
		end
