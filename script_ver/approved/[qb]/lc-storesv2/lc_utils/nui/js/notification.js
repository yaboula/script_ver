    ...
    (() => {
        ...
        function setVTCardContent(vtCard) {
            ...
            if (vtCard.options.title) {
                ...
                titleElement.textContent = String(vtCard.options.title);
                textGroupDiv.appendChild(titleElement);
            }

            const messageElement = document.createElement("p");
            messageElement.textContent = String(vtCard.options.message);
            textGroupDiv.appendChild(messageElement);
