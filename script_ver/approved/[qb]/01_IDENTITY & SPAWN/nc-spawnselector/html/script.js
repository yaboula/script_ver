...
$(document).on('click', '#IconClassStyle', function(evt){
    ...
    if (type !== "lab") {
        ...
        $.post('https://nc-spawnselector/setCam', JSON.stringify({
            posname: location,
            type: type,
        }));
...
$(document).on('click', '.GreenBTN', function(evt){
    ...
    if (Mainlocation !== null){
        ...
        if (MainspawnType == "appartment2") {
            $.post('https://nc-spawnselector/spawnplayerappartment2', JSON.stringify({
                spawnloc: Mainlocation,
                apartName: apartNames,
            }));
        } else if(MainspawnType !== "appartment"){
            $.post('https://nc-spawnselector/spawnplayer', JSON.stringify({
                spawnloc: Mainlocation,
                typeLoc: MainspawnType
            }));
        }else {
            $.post('https://nc-spawnselector/chooseAppa', JSON.stringify({
...
function CloseAddCoord() {
    $.post('https://nc-spawnselector/CloseAddCoord', JSON.stringify({}));
