...
const Circle = ({ children, occupancy, progressColor = "#2B2B2B", strokeWidth = 10 }: BarProps) => {
  ...
  return (
    <>
      ...
      <div className="absolute inset-0 z-0 rounded-full opacity-40" style={{ backgroundColor: progressColor }}></div>
      <svg className="z-10" width="100%" height="100%" viewBox="0 0 115 115">
        <path d="M 57.531845,8.532482 A 48.999363,48.999363 0 0,1 106.53121,57.531845 A 48.999363,48.999363 0 0,1 57.531845,106.53121 A 48.999363,48.999363 0 0,1 8.532482,57.531845 A 48.999363,48.999363 0 0,1 57.531845,8.532482" stroke="#0000004d" strokeWidth={strokeWidth} fill="none" />
        <path
          className="progress"
          ref={progressRef}
