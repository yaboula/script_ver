...
const WaveC: React.FC<BarProps> = ({ occupancy, progressColor = "#2B2B2B", children }) => {
  ...
  return (
    <div className="relative w-full h-full flex rounded-full bg-black/50 overflow-hidden">
