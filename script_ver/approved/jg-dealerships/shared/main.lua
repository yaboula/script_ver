...
---Validate GTA license plate format (max 8 alphanumeric/space characters)
---@param plate string
---@return boolean
...
---Round a number to specified decimal places (negative values round to 10's, 100's, etc.)
---@param num integer
---@param dp? integer Decimal places (default: 0)
---@return number
